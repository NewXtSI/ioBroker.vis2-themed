  ...
  async function getExposesMap() {
    exposesMapPromise ??= import("virtual:mf-exposes-ssr:__mfe_internal__vis2ThemedWidgets__customWidgets_js").then((mod) => mod.default ?? mod);
  ...
  async function init(shared = {}, initScope = []) {
    ...
    const initToken = { from: "vis2ThemedWidgets" };
