...
| [NEWFEAT] button image/Symbol Auswahl soll auch möglich sein und zusätzlich zum text (oder statt des text) dargestellt werden. Bei Symbol. Bei Symbol soll es auch noch zwei Auswahlmöglichkeiten für Farbe (aktiv/inaktiv) geben, default Textfarbe und Akzentfarbe | 2 | PENDING_HASH | 
| [NEWFEAT] button Checkbox für Wert invertiert | 1 | PENDING_HASH | 
...
| Toggle soll in Verbindung mit Pushbutton auch immer wieder "herausspringen". Beim Drücken wird dann aber entweder true oder false geschrieben | 1 | Button | PENDING_HASH |
| Pushbutton soll auch gedrückt werden können, wenn der Wert bereits passend steht. Dann erfolgt nur das optische Drücken | 1 | Button | PENDING_HASH |
