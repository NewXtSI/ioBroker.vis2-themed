...
| [NEWFEAT] themed_bar Checkbox für vertikal | 1 | PENDING_HASH | 
| [NEWFEAT] button Navigationsmodus: Button soll in den Settings eine Section haben () | 1 | | 
...
| Pushbutton schreibt wert auch beim zurückspringen. Der Wert soll NUR beim Drücken geschrieben werden! | 1 | Button | PENDING_HASH |
| Bar color kill die gesamte Optik, da ohne shadows, transparenz und ähnliches. Auch sollte der "Barindicator" etwas (minimal) mehr Abstand zur versenkten Bar haben | 1 | Bar | PENDING_HASH | 
